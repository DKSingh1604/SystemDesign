...
int main() {
    try {
        ...
        cout << "\n-- Sequential Playback --\n";
        application->selectPlayStrategy(PlayStartegyType::SEQUENTIAL);
        application->loadPlaylist("Bollywood Vibes");
        application->playAllTracksInPlaylist();

        cout << "\n-- Random Playback --\n";
        application->selectPlayStrategy(PlayStartegyType::RANDOM);
        application->loadPlaylist("Bollywood Vibes");
        application->playAllTracksInPlaylist();

        cout << "\n-- Custom Queue Playback --\n";
        application->selectPlayStrategy(PlayStartegyType::CUSTOM_QUEUE);
        application->loadPlaylist("Bollywood Vibes");
